...
export default class DraggableCardInPopup extends Component {
    ...
    componentDidMount() {
        this.props.dispelInfiniteTsukuyomi()
        console.log("in draggable card in popup, this.props.storedCard", this.props.storedCards)
    }
    render() {
        return (
            <Animated.View
                ...
                <TouchableOpacity onLongPress={this.examineCard} activeOpacity={1} style={{ flexDirection: "column", justifyContent: "flex-end", alignItems: "center", width: 150 * 0.65, height: 300 * 0.65 }}>
                    <FadeScaleImage
                        ...
                        resizeMode={"contain"} style={((this.props.dragBegin && this.state.selectedCard && this.props.inDreamState && !this.state.overReturnToHand) ? { width: 75 * 0.65, height: 150 * 0.65, alignSelf: "center", bottom: -10, zIndex: 500 } : { width: 150 * 0.65, height: 300 * 0.65, alignSelf: "center", bottom: -20 })} />
                </TouchableOpacity>
            </Animated.View>
        );
    }
