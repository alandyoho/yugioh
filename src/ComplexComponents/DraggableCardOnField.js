    ...
    render() {
        return (
            <Animated.View
                ...
                <TouchableOpacity disabled={this.props.user ? true : false} onLongPress={this.examineCard} onPress={this.handleDoubleTap} activeOpacity={1} style={{ flexDirection: "column", justifyContent: "center", alignItems: "center", transform: this.props.user ? (this.props.item.user && this.props.user === this.props.item.user ? [{ rotate: "0deg" }] : [{ rotate: '180deg' }]) : [{ rotate: '180deg' }] }}>
