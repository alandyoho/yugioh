    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, flexDirection: 'row', flexWrap: 'wrap', justifyContent: "center", alignItems: "flex-end" }}>
                ...
                <TouchableOpacity style={styles.viewStyles} onLongPress={() => this.examineCard(thatBoard.st[6])}>
                ...
                {[1, 2, 3, 4, 5].map(cardIndex => (<TouchableOpacity key={cardIndex} style={styles.viewStyles} onLongPress={() => this.examineCard(thatBoard.st[cardIndex])}>
